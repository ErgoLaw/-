...
Процедура ОбработкаПроведения(Отказ, Режим)  
	...
	ТаблицаБлокировки.Колонки.Добавить("МестоНахожденияТовара"); 
	
	ТаблицаБлокировки.ЗаполнитьЗначения(СкладОтправитель, "МестоНахожденияТовара");
	...
	ЭлементБлокировки.ИспользоватьИзИсточникаДанных("Склад", "МестоНахожденияТовара");	
